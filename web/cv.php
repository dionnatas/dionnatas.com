			...
			<div class="well well-lg col-md-8">
				<div class="row">
					...
					<div class="col-xs-4 col-md-3">
						<a class="thumbnail">
						<img src="images\Dionn_Seg.jpg" width="100%">
						</a>
					</div>
				</div>	
			</div>
			...
			<div class="col-md-8">
				<div class="row">
					<div class="col-xs-4 col-md-8">
						<p class="lead">Objetivo Profissional</p>
						<hr>
						<h4 class="text-success">Programador/Desenvolvedor Jr.</h4>
						<br><br>
						<p class="lead">Experiências</p>
						<hr>
						<h4>
							<p class="text-success">Teleperformance CRM S/A - (09/2014 - Atual)</p>
							<h5>
						...
						<br>
						<h4>
							<p class="text-success">Unilever do Brasil S/A - (04/2010 - 01/2013)</p>
							<h5>
						...
						<p class="lead">Educação</p>
						<hr>
						<h4 class="text-success">Universidade Anhembi Morumbi - (01/2014 - 06/2016)</h4>
						<h5>
					...
					<div class="col-xs-4 col-md-4">
						<blockquote>
							<p class="lead text-success">Linguagens</p>
							<hr>
							<h5>
						...
						<blockquote>
							<p class="lead text-success">Outros Conhecimentos</p>
							<hr>
							<h5>
